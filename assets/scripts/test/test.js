var MonsterEnum = require('../data/MonsterEnum')
var MDC = require('../data/MonsterDataConst')
var MonsterFunction = require('../data/MonsterFunction')
var FuncParamTest = require('./FuncParamTest')
...
const functionsArray=[
	MDC.getMonsterData,
	MonsterFunction.raceRestrainFactor,
	MonsterFunction.attributeRestrainFactor,
	MonsterFunction.moveAttackTypeRestrainFactor,
	MonsterFunction.allRestrainFactor,
	MonsterFunction.getMoveAttackType
];
//待测试参数表
...
FuncParamTest.smokeTest(functionsArray,parametersArray)
