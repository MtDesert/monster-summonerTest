...
type攻击类型AttackType
isMagic物魔性,undefined为物理,true为魔法
through贯通,undefined为不可贯通(攻击会被对方接下而不会往后继续传递),true为可贯通
*/
...
const monsterDataList=[
	...
	explain:"测试用的怪物",
	atkType:{attrib:Attribute.None,type:AttackType.Direct,through:true},
	feature:[
		Feature.AttrDefend,
		Feature.DirectAtkDefend,
		Feature.IndirectAtkDefend,
		Feature.BombAtkDefend,
		Feature.Break,
		Feature.Capture,
		Feature.DestoryMagic,
		Feature.DragonSlay,
	...
	atkType:{attrib:Attribute.None,type:AttackType.Indirect}},
	...
	atkType:{attrib:Attribute.Ground,type:AttackType.Indirect,through:true},
	feature:[Feature.Monosome,Feature.GroundAttrDefend]},
	...
	atkType:{attrib:Attribute.Ice,type:AttackType.Indirect,through:true},
	feature:[Feature.Monosome,Feature.IceAttrDefend]},
	...
	atkType:{attrib:Attribute.None,type:AttackType.Direct},
	...
	atkType:{attrib:Attribute.Fire,type:AttackType.Indirect,isMagic:true},
	feature:[Feature.BombAtkDefend]},
	...
	atkType:{attrib:Attribute.Fire,type:AttackType.Indirect},
	feature:[Feature.BombAtkDefend]},
	...
	atkType:{attrib:Attribute.None,type:AttackType.Direct,isMagic:true},
	feature:[Feature.Capture]},
	...
	atkType:{attrib:Attribute.None,type:AttackType.Direct},
	feature:[Feature.IndirectAtkDefend,Feature.Monosome]},
	...
	atkType:{attrib:Attribute.Thunder,type:AttackType.Indirect,isMagic:true}},
	...
	atkType:{attrib:Attribute.None,type:AttackType.Bomb},
	feature:[Feature.Plant,Feature.Break]},
	...
	atkType:{attrib:Attribute.None,type:AttackType.Indirect,through:true},
	feature:[Feature.Monosome]},
	...
	atkType:{attrib:Attribute.None,type:AttackType.Bomb},
	feature:[Feature.Machine,Feature.BombAtkDefend]},
	...
	atkType:{attrib:Attribute.None,type:AttackType.Indirect,through:true},
	feature:[Feature.Monosome,Feature.AttrDefend]},
	...
	atkType:{attrib:Attribute.Ice,type:AttackType.Indirect,isMagic:true}},
	...
	atkType:{attrib:Attribute.None,type:AttackType.Direct,through:true},
	feature:[Feature.Machine,Feature.IndirectAtkDefend]},
	...
	atkType:{attrib:Attribute.Ground,type:AttackType.Indirect,isMagic:true},
	feature:[Feature.BombAtkDefend]},
	...
	atkType:{attrib:Attribute.Ground,type:AttackType.Indirect,isMagic:true},
	feature:[Feature.Break,Feature.IndirectAtkDefend]},

	{num:35,name:"雷霆龙",race:Race.Dragon,lv:3,moveType:MoveType.Walk,
	health:440,skill:0,attack:1,range:7,speed:16,move:6,mp:20,summon:29,physicDamage:0.7,magicDamage:1.3,
	explain:"4大元素龙之一。体内流动的电气通过角发射出去，烧焦敌人，或是麻痹其运动神经。",
	atkType:{attrib:Attribute.Thunder,type:AttackType.Direct,through:true},
	feature:[Feature.Monosome,Feature.ThunderAttrDefend]},
	...
	atkType:{attrib:Attribute.None,type:AttackType.Indirect},
	feature:[Feature.FireAttrDefend]},
	...
	atkType:{attrib:Attribute.None,type:AttackType.Direct},
	feature:[Feature.Monosome,Feature.IndirectAtkDefend]},
	...
	atkType:{attrib:Attribute.Thunder,type:AttackType.Direct},
	feature:[Feature.ThunderAttrDefend]},
	...
	atkType:{attrib:Attribute.None,type:AttackType.Direct},
	feature:[Feature.Capture,Feature.SoftBody]},
	...
	atkType:{attrib:Attribute.None,type:AttackType.Direct},
	feature:[Feature.Break,Feature.DirectAtkDefend]},
	...
	atkType:{attrib:Attribute.None,type:AttackType.Indirect,isMagic:true},
	feature:[Feature.Monosome]},
	...
	feature:[Feature.Monosome,Feature.FireAttrDefend]},
	...
	atkType:{attrib:Attribute.Ground,type:AttackType.Indirect},
	feature:[Feature.Plant,Feature.IndirectAtkDefend]},
	...
	atkType:{attrib:Attribute.None,type:AttackType.Direct},
	feature:[Feature.Aquatic,Feature.SoftBody]},
	...
	atkType:{attrib:Attribute.None,type:AttackType.Direct},
	feature:[Feature.DragonSlay,Feature.FireAttrDefend]},
	...
	atkType:{attrib:Attribute.None,type:AttackType.Direct},
	feature:[Feature.DefenceRateIgnore]},
	...
	atkType:{attrib:Attribute.Sacred,type:AttackType.Direct}},

	{num:65,name:"热带食人花",race:Race.Beast,lv:2,moveType:MoveType.Walk,
	health:180,skill:0,attack:15,range:8,speed:32,move:5,mp:8,summon:13,physicDamage:1.0,magicDamage:0.9,
	...
	atkType:{attrib:Attribute.Fire,type:AttackType.Indirect,through:true},
	feature:[Feature.FireAttrDefend]},
	...
	atkType:{attrib:Attribute.None,type:AttackType.Direct},
	feature:[Feature.Machine,Feature.Stealth]},
	...
	atkType:{attrib:Attribute.None,type:AttackType.Direct},
	feature:[Feature.Capture,Feature.Stealth]},
	...
	atkType:{attrib:Attribute.Sacred,type:AttackType.Direct},
	feature:[Feature.Monosome,Feature.BombAtkDefend]},
	...
	atkType:{attrib:Attribute.Ground,type:AttackType.Indirect},
	feature:[Feature.Plant,Feature.BombAtkDefend]},
	...
	atkType:{attrib:Attribute.None,type:AttackType.Direct},
	feature:[Feature.Capture,Feature.Aquatic]},
	...
	atkType:{attrib:Attribute.Ground,type:AttackType.Direct},
	feature:[Feature.Plant,Feature.DirectAtkDefend]},
